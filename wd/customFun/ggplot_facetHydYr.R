...
#' 
ggplot_facetHydYr<- function(DF_in,metaD,varNames,startDate,endDate,plotPath,dpi){
  ...
  ggplot2::ggsave(paste0(plotPath, metaD$lakeName,"_facetHydYr.png"), 
                  height = ((max(plotHydYr$hydroyr)-min(plotHydYr$hydroyr)) * 2), 
                  width = 7.5, 
                  dpi = 400)
